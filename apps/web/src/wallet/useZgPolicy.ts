import { env } from "@/env";
import { account, fundKeypair, fundPubkey, server } from "@/lib/stellar-smart-wallet";
import { Address, Operation, scValToNative, rpc as SorobanRpc, TransactionBuilder, xdr } from "@stellar/stellar-sdk";
